 ...
 * generated in the com.sabinshop.orders.api.integrations.lib.catalogue package. 
...
public class ObjectFactory {
    ...
    private final static QName _RetrieveProduct_QNAME = new QName("http://sabinshop.com/services/eCommerce/v1", "RetrieveProduct");
    private final static QName _ECommerceErrorFault_QNAME = new QName("http://sabinshop.com/services/eCommerce/v1", "ECommerceErrorFault");
    private final static QName _RetrieveProductResponse_QNAME = new QName("http://sabinshop.com/services/eCommerce/v1", "RetrieveProductResponse");
    private final static QName _RetrieveProductRequestMessageId_QNAME = new QName("http://sabinshop.com/schemes/messages/v1", "id");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.sabinshop.orders.api.integrations.lib.catalogue
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sabinshop.com/services/eCommerce/v1", name = "RetrieveProduct")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sabinshop.com/services/eCommerce/v1", name = "ECommerceErrorFault")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sabinshop.com/services/eCommerce/v1", name = "RetrieveProductResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sabinshop.com/schemes/messages/v1", name = "id", scope = RetrieveProductRequestMessage.class)
